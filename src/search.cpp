...
void update_all_stats(const Position&      pos,
    ...
    {
        update_quiet_histories(pos, ss, workerThread, bestMove, quietMoveBonus + 100 * PvNode);
    ...
    else
    {
        ...
        captureHistory[moved_piece][bestMove.to_sq()][captured] << quietMoveBonus + 100 * PvNode;
    }
